...
describe("useStore", () => {
  ...
  describe("Re-render scope", () => {
    ...
    function ContactPersonSubForm({ company }: { company: Store<Company> }) {
      const companyContacts$ = useStore(company.contacts);
    ...
    function ProfileForm() {
      ...
      const companyBasic$ = useStore(company.basic);
    ...
    test("should update according to useStore", () => {
    ...
    test("should update according to store", () => {
      act(() => {
     ...
     *   const companyContacts$ = useStore(compantConctacts)
     * }
     * ```
     */
    test("should not update parent if property only used by child's useStore", () => {
